package example.olive_young.product.api.service;

import example.olive_young.product.api.controller.request.EndPromotionRequest;
import example.olive_young.product.api.controller.request.ProductRequest;
import example.olive_young.product.api.controller.request.StartPromotionRequest;
import example.olive_young.product.api.service.response.ProductResponse;
import example.olive_young.product.api.service.response.PromotionStatus;
import example.olive_young.product.domain.Product;
import example.olive_young.product.domain.ProductRepository;
import example.olive_young.product.domain.Promotion;
import example.olive_young.product.domain.PromotionPeriod;
import example.olive_young.product.domain.PromotionRepository;
